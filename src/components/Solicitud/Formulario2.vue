	...
	<div>
		<section class="container form2">
			<div class="container cont-color" :style="myStyle">
				<form class="form">
					<p class="p">Por favor, ten a la mano tu identificación y comprobante de domicilio escaneados, los vamos a necesitar mas adelante. <span class="span">*</span></p>
					<label>Paso 2 de 5</label>
					<div class="row">
					...
					<br>
					<p>Fecha de Nacimiento<span class="span">*</span></p>
					<div class="row">
						<select>
					...
					<br>
					<p>Entidad Federativa de Nacimiento<span class="span">*</span></p>
					<div class="row">
						<select class="select">
					...
					<br>
					<p>Estado Civil<span class="span">*</span></p>
					<div class="row">
						<select class="select">
							<option value="Soltero/a." >Soltero/a.</option><option value="Comprometido/a." >Comprometido/a.</option><option value="Casado/a." >Casado/a.</option><option value="Divorciado/a." >Divorciado/a.</option><option value="Viudo/a." >Viudo/a.</option>
						</select>
					</div>
					<br>
					<p>Género<span class="span">*</span></p>
					<div class="row">
						<select class="select">
